...
<img src="/posts/2/native_start.png" alt="jvm architecture" style="height: 30px; text-align: center; margin: 0 auto;     margin-bottom: 20px;" />

<br><br>
Java에서 생성하는 유저 스레드와 커널 스레드의 1:1 매핑을 개략적으로 구조화 하면 아래와 같다.
<img src="/posts/2/java_os_threads.png" alt="jvm architecture" style="height: 250px; text-align: center; margin: 0 auto;     margin-top: 20px;" />
...
<img src="/posts/2/java_thread_state.png" alt="jvm architecture" style="height: 280px; text-align: center; margin: 0 auto;     margin-bottom: 20px;" />
...
<img src="/posts/2/java_thread_life-cycle.png" alt="java thread life cycle" style="height: 390px; text-align: center; margin: 0 auto; margin-top: 20px;" />
